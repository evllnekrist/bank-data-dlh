  ...
  // -------------------------------------- CALLED BY AJAX ---------------------------- start
    ...
    public function post_delete($id)
    {
        try {
          ...
          if($exist){
            return json_encode(array('status'=>false, 'message'=>'Ada user yang berhubungan dengan peran ini. Ubah dahulu peran akun yang terkait jika ingin menghilangkan peran, atau cukup nonaktifkan peran lewat menu edit', 'data'=>$exist));
          }
