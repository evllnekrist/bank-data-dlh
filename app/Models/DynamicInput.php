...
class DynamicInput extends Model
{
    ...
    protected $fillable = [
        ...
        'default_value',
        'label',
        'behaviour', // akan digunakan untuk menambatkan sifat-sifat seperti, tidak boleh ada spasi atau harus ada numerik (diatur lewat class). Atau untuk input file, menentukan attribute ACCEPT img atau doc (diatur lewat config)
