                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                                        <div class="h-full w-full text-center flex flex-col items-center justify-center items-center">
                                            ...
                                            <div class="flex flex-auto max-h-48 w-4/5 mx-auto py-3 {{!@$selected->img_main?'hidden':''}}" id="input-img-preview-0">
                                        ...
                                        <input name="img_main" id="input-img-btn-0" data-index-input-img="0" type="file" accept="{{implode(',',Config::get('app.accept_mimes')['img'])}}"
                                        class="input-img mt-2 block w-full text-xs border border-gray-300 rounded-lg cursor- hidden">
                                    </label>
                                </div>
                            </div>
