                            ...
                            <div class="grid grid-cols-12 gap-x-5 mb-3">
                                <div class="col-span-12 mb-5">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Pilih salah satu atau lebih, tambahkan jika ada yang baru..." class="tom-select w-full" multiple="multiple">
                                                <option value=""></option>
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Pilih salah satu..." class="tom-select w-full">
                                                <option value=""></option>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Pilih salah satu..." class="tom-select w-full" onchange="getDynamicInputs()">
                                                <option value=""></option>
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                                        <div class="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                                            ...
                                            <input name="img_main" data-index-input-img="0" type="file" accept="{{implode(',',array_merge(Config::get('app.accept_mimes')['img'],Config::get('app.accept_mimes')['doc']))}}"
        ...
        <div class="col-span-12">
            <div class="intro-y box lg:mt-5" id="dynamic-input-inner-wrap-wrap" style="display:none; z-index: 0 !important">
                ...
                <form id="dynamic-input-inner-wrap" class="p-5">
                    <div class="flex flex-col xl:flex-row p-5">
            ...
            <div class="intro-y mx-auto" id="dynamic-input-inner-wrap-loading" style="display:none;">
